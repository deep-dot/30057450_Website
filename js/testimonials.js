document.getElementById('load-more-btn').addEventListener('click', function() {
    ...
    var testimonialSection = document.querySelector('.testimonial-cards');
    
    // Add new testimonials (example)
    var newTestimonials = `
      <div class="card">
        <div class="stars">★★★★★</div>
    ...
    // Append new testimonials to the testimonial section
    testimonialSection.innerHTML += newTestimonials;
  });
